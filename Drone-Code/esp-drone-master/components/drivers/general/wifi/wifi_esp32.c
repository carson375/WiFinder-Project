...
void wifiInit(void)
{
    ...
    memcpy(wifi_config_ap.ap.ssid, WIFI_SSID, strlen(WIFI_SSID) + 1) ;
    wifi_config_ap.ap.ssid_len = strlen(WIFI_SSID);
    memcpy(wifi_config_ap.ap.password, WIFI_PWD, strlen(WIFI_PWD) + 1) ;
