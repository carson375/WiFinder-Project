...
static void testProps(sensorData_t *sensors)
{
  ...
  else if (testState == measureProp)
  {
    ...
    if (i == 1)
    {
      motorsSetRatio(motorToTest, SERVO_MAX_PULSEWIDTH_US);
    }
    else if (i == 50)
    {
      motorsSetRatio(motorToTest, SERVO_MIN_PULSEWIDTH_US);
    }
  ...
  else if (testState == testBattery)
  {
    ...
    if (i == 1)
    {
      motorsSetRatio(MOTOR_M1, SERVO_MAX_PULSEWIDTH_US);
      motorsSetRatio(MOTOR_M2, SERVO_MAX_PULSEWIDTH_US);
      motorsSetRatio(MOTOR_M3, SERVO_MAX_PULSEWIDTH_US);
      motorsSetRatio(MOTOR_M4, SERVO_MAX_PULSEWIDTH_US);
    }
    else if (i < 50)
    {
    ...
    {
      motorsSetRatio(MOTOR_M1, SERVO_MIN_PULSEWIDTH_US);
      motorsSetRatio(MOTOR_M2, SERVO_MIN_PULSEWIDTH_US);
      motorsSetRatio(MOTOR_M3, SERVO_MIN_PULSEWIDTH_US);
      motorsSetRatio(MOTOR_M4, SERVO_MIN_PULSEWIDTH_US);
